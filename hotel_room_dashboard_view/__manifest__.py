...

{
    ...
    'depends': ['hotel_management', 'base','web'],
    'data': [
    ...
    'assets': {
        'web.assets_backend': [
            ...
            '/hotel_room_dashboard_view/static/src/js/dashboard_reload.js',
            '/hotel_room_dashboard_view/static/src/js/fullcalender.js',
            '/hotel_room_dashboard_view/static/src/js/schedular.js',
            '/hotel_room_dashboard_view/static/src/css/container.css',
            ...
            '/hotel_room_dashboard_view/static/src/css/box.css',
            # '/hotel_room_dashboard_view/static/src/xml/**/*',
            # '/hotel_room_dashboard_view/static/src/xml/demobase.xml',
            '/hotel_room_dashboard_view/static/src/xml/base.xml',
            # '/hotel_room_dashboard_view/static/src/xml/template.xml',
            '/hotel_room_dashboard_view/static/src/xml/demotemplate.xml',
